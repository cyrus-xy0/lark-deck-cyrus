...
> `lark-deck-cyrus`, `upload-parser`, `deck-planner`, `deck-renderer`,
...
ln -s ~/Projects/lark-deck-cyrus/skills/upload-parser ~/.claude/skills/upload-parser
...
- To hand the same generator/bot to a cloud agent, run
  ...
  `docs/ops/CLOUD_AGENT.md` for the exact agent prompt.
