...
## slide-21 (content-2col) — 21 Pattern I · 6-step Pipeline
demo_tag: Pattern I · 6-step Pipeline
title_zh: 端到端项目五阶段
num: 01
title_zh_02: 访谈
li: 6 个部门
...
## slide-28 (content-2col) — 28 用法 · 怎么开始
demo_tag: 怎么开始
title_zh: 想用这套设计语言 · 三步开始
bf_tag: 01
bf_title: 告诉 Claude Code 用 feishu-deck-h5 技能
bf_desc: "帮我做一份飞书风格 deck",skill 自动启动 · 给到主题或材料就好。
bf_tag_02: 02
bf_title_02: 每张 slide 改文字编辑 texts.md
bf_desc_02: 布局对了之后改文字,不动 HTML,双击 apply.command 重新生成。
bf_tag_03: 03
bf_title_03: 交付前 validator --strict --visual
bf_desc_03: 五秒跑完所有规则 · 字号 / 对齐 / 层级 / 溢出全检 · 0 错才能交付。
